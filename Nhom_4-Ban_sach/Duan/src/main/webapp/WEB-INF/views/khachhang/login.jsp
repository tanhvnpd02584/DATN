			...
			<div class="row">
				...
				<div
					...
					<div class="login-form">
						<form method="post" action="/khachhang/login">
							<div class="single-login">
								<label>Email<span>*</span></label> <input type="email"
									name="taikhoan" />
							</div>
							<div class="single-login">
								<label>Mat khau <span>*</span></label> <input type="password"
									name="matkhau" />
							</div>
							${message}
							<div class="single-login single-login-2">
								<input id="rememberme" type="checkbox" name="rememberme"
									value="forever"> <span>Nhớ mật khấu</span> <br>
							</div>
							<div style="text-align: center;">
								<button>Login</button>
							</div>
						</form>
						<a href="khachhang/forget">Quên mật khẩu?</a>
					</div>
				</div>
			</div>
		</div>
