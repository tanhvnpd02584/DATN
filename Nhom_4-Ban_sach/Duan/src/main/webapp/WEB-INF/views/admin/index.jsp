									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												Số đầu sách hiện có</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">${slsach}</div>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												Số lượng sách đã bán ra</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">${slsachban}</div>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${dt[1]}</div>
												</div>
											</div>
										</div>
										<div class="col-auto">
						...
						<div>
							<div>
								...
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">Doanh số
										sách bán ra</h6>
								</div>
								<!-- Card Body -->
								<div>
									<div>
										<jsp:include page="report/chart-line.jsp"></jsp:include>
									</div>
								</div>
							</div>
						</div>
