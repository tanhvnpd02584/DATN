...
<title>Cập nhập danh muc sách</title>
								...
								<div class="col-lg-7">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Cập nhật danh mục
												sách!</h1>
										</div>
										<form:form class="user" modelAttribute="form"
											action="nhanvien/danhmuccn" method="POST">
											<div class="form-group">
												<label>ID danh mục:</label>
												<form:input path="iddanhmuc"
													class="form-control form-control-user"
													readonly="true" />
											</div>
											<div class="form-group">
												<form:hidden path="iddanhmuc" />
