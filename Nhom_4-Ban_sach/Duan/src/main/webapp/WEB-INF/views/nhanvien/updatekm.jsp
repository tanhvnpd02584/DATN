								...
								<div class="col-lg-7">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Cập nhật khuyến mãi!</h1>
										</div>
										<form:form class="user" modelAttribute="form"
											action="nhanvien/khuyenmai/update" method="POST">
											<form:input path="idkm" readonly="true"
												class="form-control form-control-user"
												id="exampleInputEmail" />
											<div class="form-group">
												<label>Tên sách:</label> <br> <input type="text"
													readonly="readonly" value="${form.sach.tensach}">
												<form:hidden path="sach.idsach"
													class="form-control form-control-user"
													id="exampleInputEmail" />
											</div>
											<div class="form-group">
												<label>Tên khuyến mãi:</label>
												<form:input path="tenchuongtrinh"
													class="form-control form-control-user"
													id="exampleInputEmail" />
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label for="b">Trạng thái:</label><br>
												<c:if test="${form.trangthai == true}">
												<label>Đang bật</label>
												<form:hidden path="trangthai"/>
												</c:if>
												<c:if test="${form.trangthai == false}">
