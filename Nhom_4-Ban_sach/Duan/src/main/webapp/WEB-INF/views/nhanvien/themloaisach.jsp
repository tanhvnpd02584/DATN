...
<title>Thêm thể loại sách mới</title>
...
<script type="text/javascript">
	function o() {
		if (document.form.exampleInputEmail.value === "") {
			alert("Vui lòng nhập tên loại sách");
			document.form.exampleInputEmail.focus();
								...
								<div class="col-lg-7">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Thêm thể loại sách mới!</h1>
										</div>
										<form:form class="user" modelAttribute="form"
											action="nhanvien/themloaisach" method="POST" name="form"
											onclick="return o()">
