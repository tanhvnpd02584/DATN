								...
								<div class="col-lg-7">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Thêm sách mới</h1>
										</div>
										<form:form class="user" modelAttribute="form"
											enctype="multipart/form-data" action="/nhanvien/themsach"
											method="post" name="form" onclick="return clck()">
											<div class="form-group">
												<label for="cars">Chọn thể loại:</label> <br>
												<form:select path="loaisach.idloai" id="cars">
													<c:forEach var="r" items="${dm}">
														<optgroup label="${r.tendanhmuc}">
															<c:forEach var="c" items="${r.loaisach}">
											...
											<div class="form-group">
												...
												<form:input path="nhaxuatban"
													class="form-control form-control-user" id="nxb" />
											</div>
											<div class="form-group">
												<label>Ngày phát hành:</label> <input type="date" name="ngay"
